  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Ocorreu um erro no nosso sistema. Tente recarregar ou voltar para o início.
        </p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Vai Até Você — Entregador" },
      { name: "description", content: "App do entregador parceiro Vai Até Você." },
      { name: "author", content: "Vai Até Você" },
      { property: "og:title", content: "Vai Até Você — Entregador" },
      { property: "og:description", content: "App do entregador parceiro Vai Até Você." },
